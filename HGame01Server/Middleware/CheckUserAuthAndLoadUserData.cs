...
namespace HGame01Server.Middleware;
...
public class CheckUserAuthAndLoadUserData
{
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        if (formString.Contains("/api/Login", StringComparison.OrdinalIgnoreCase) ||
            formString.Contains("/api/CreateAccount", StringComparison.OrdinalIgnoreCase) ||
            formString.Contains("/api/Admin", StringComparison.OrdinalIgnoreCase))
        {
            await _next(context);
            return;
        }
